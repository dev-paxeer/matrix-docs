---
title: "Architecture"
description: "Chronos is a centralized control plane: one chronosd process serves every per-user agent in the Matrix fleet. It is NOT a per-daemon timer; it is the single source of truth for scheduled time."
---
