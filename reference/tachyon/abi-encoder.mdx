---
title: "ABI Encoder"
description: "The ABI encoder bridges JSON-decoded values to the exact Go types required by go-ethereum's ABI packer for method calls and constructor arguments."
---
