---
title: "Coding Standards, Security, and Contributor Policy: Hook and Lifecycle Conventions"
description: "This section documents the hook rules that shape contributor workflow across the repository’s language-specific rule sets. The shared baseline defines when hooks run, how much a..."
---
