---
title: "Coding Standards, Security, and Contributor Policy - Patterns, architecture heuristics, and performance guidance"
description: "This slice of the repository is policy material, not runtime product logic. The documents in rules/ define reusable implementation heuristics for choosing proven starting points..."
---
