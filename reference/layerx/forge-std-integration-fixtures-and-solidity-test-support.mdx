---
title: "LayerX Forge Std Integration, Fixtures, and Solidity Test Support"
description: "This section captures the vendored Forge Standard Library surface that LayerX uses to write Solidity tests, plus the local test doubles and fixture files that exercise token beh..."
---
