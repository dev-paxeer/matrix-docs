---
title: "Financial Workflows Service Entrypoints, API Server, Docs, and Schema Migrations"
description: "This section covers the Deus service shell: the daemon entrypoint, operator CLI, HTTP server assembly, developer sign-in flow, channel and settlement handlers, the repository do..."
---
